...
def count_tweets_based_on_words(word):
    ''': parameters a word
        ...
        uses 2 databases index_database and tweet_database
        supported by views'''
    statename_countoftweets={}
...
def count_sin_twitter(pathtofile):
    ''':parameter pathtofile containing the words separated by '\n'
       :return type dict containing  info'''
    info={}
    tweet_index.clear()
    word_stateList = {}
    with open(pathtofile, "r", encoding='utf-8') as fd:
        for word in fd:
...
print(count_sin_twitter("sin_wordlists/emotion_of_envy_wordlist"))
print("Total tweets based on Sloth")
print(count_sin_twitter("sin_wordlists/exercise&work_Sloth_wordlist"))
print("Total tweets based on Greed")
print(count_sin_twitter("sin_wordlists/money_greedy_wordlist"))
print("Total tweets based on Lust")
print(count_sin_twitter("sin_wordlists/SexualDirty_Lust_Wordlist"))